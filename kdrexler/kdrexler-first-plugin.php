...
function kdrexler_horizontal_ad ($content) {
    if ( !is_admin() ) {
        ...
        if (isset($options['ad_slot_horizontal']) && strlen($options['ad_slot_horizontal'])>0 && isset($options['ad_slot_horizontal_visible']) && isset($options['ad_slot_horizontal_visible'])==1) {
            return  $content.'<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script><!-- Display Ad1 --><ins class="adsbygoogle" style="display:block" data-ad-client="'.esc_attr($options['api_key']).'" data-ad-slot="'.$options['ad_slot_horizontal'].'" data-ad-format="auto" data-full-width-responsive="false"></ins><script>     (adsbygoogle = window.adsbygoogle || []).push({});</script>';
        } else {
            return $content;
        }
...
function kdrexler_square_ad ($content) {
    if ( !is_admin()  ) {
        ...
        if (isset($options['ad_slot_square']) && strlen($options['ad_slot_square'])>0 && isset($options['ad_slot_square_visible']) && isset($options['ad_slot_square_visible'])==1) {
            return $content.'<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script><!-- Display Ad1 --><ins class="adsbygoogle" style="display:block" data-ad-client="'.esc_attr($options['api_key']).'" data-ad-slot="'.$options['ad_slot_square'].'" data-ad-format="auto" data-full-width-responsive="true"></ins><script>     (adsbygoogle = window.adsbygoogle || []).push({});</script>';
        } else {
            return $content;
        }
